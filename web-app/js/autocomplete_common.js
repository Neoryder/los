...
//                        return [day == 1 ,""];
    ...
    function formatSelectionTeachers(result) {
        ...
        console.log(result);
        if(result.label){
            return result.assignedNumber+"|"+result.label;
        } else if(result.id){
            return result.text;
        } else {
    ...
    $("#r305").select2({
    	...
    	minimumInputLength: 1,
    	dropdownCssClass: "bigdrop",
    	templateResult: formatResultR305,
    	templateSelection: formatSelectionR305
    });
    
    var $r305Select = $("#r305");
    $r305Select.on("change", function (e) {
    	$("#r305Id").val($("#r305").val())
    });
    ...
    $("#r309").select2({
    	...
    	minimumInputLength: 1,
    	dropdownCssClass: "bigdrop",
    	templateResult: formatResultR309,
    	templateSelection: formatSelectionR309
    });
    
    var $r309Select = $("#r309");
    $r309Select.on("change", function (e) {
    	$("#r309Id").val($("#r309").val())
    });
    
    function formatResultR309(results) {
    ...
    function formatSelectionR309(result) {
    	console.log('formatSelectionR309');
    	console.log(result);
