...
<html>
    ...
    <script type="text/javascript">
		...
		<a href="#edit-r305" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-r305" class="content scaffold-edit" role="main">
			<h1><g:message code="default.edit.label" args="[entityName]" /></h1>
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${r305Instance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${r305Instance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${r305Instance?.version}" />
				<fieldset class="form">
