...
<html>
	...
	<body>
        ...
        function formatSelectionR303(result) {
            ...
            if(result.dateFrom){
                return result.weekNo+"-"+result.date+"-"+result.dateFrom+"-"+result.dateTo+"|"+result.lokal+"|"+result.teacher;
            } else {
                return result.text;
            }
        }
		...
		<a href="#create-r309Entry" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-r309Entry" class="content scaffold-create" role="main">
			<h1><g:message code="default.create.label" args="[entityName]" /></h1>
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${r309EntryInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${r309EntryInstance}" var="error">
