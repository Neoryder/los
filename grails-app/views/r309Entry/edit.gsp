...
<html>
	...
	<script type="text/javascript">
		...
		<a href="#edit-r309Entry" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-r309Entry" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${r309EntryInstance?.version}" />
				<fieldset class="form">
