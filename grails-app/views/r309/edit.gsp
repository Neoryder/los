...
<html>
    ...
    <script type="text/javascript">
		...
		<a href="#edit-r309" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-r309" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${r309Instance?.version}" />
				<fieldset class="form">
