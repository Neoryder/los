...
<html>
	...
	<body>
		<a href="#show-r309" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="show-r309" class="content scaffold-show" role="main">
			<h1><g:message code="default.show.label" args="[entityName]" /></h1>
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<ol class="property-list r309">
				...
				<li class="fieldcontain">
					<span id="entry-label" class="property-label"><g:message code="r309.entry.label" default="Entry" /></span>
					
						<g:each in="${r309Instance.entry}" var="e">
						<span class="property-value" aria-labelledby="entry-label"><g:link controller="r309Entry" action="show" id="${e.id}">${e?.encodeAsHTML()}</g:link></span>
						</g:each>
				...
				<li class="fieldcontain">
                    ...
                    <span class="property-value" aria-labelledby="teacher-label"><g:link controller="teacher" action="show" id="${r309Instance?.teacher?.id}">${r309Instance?.teacher}</g:link></span>
				</li>
				</g:if>
			...
			<g:form>
				<fieldset class="buttons">
					<g:hiddenField name="id" value="${r309Instance?.id}" />
					<g:link class="edit" action="edit" id="${r309Instance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
